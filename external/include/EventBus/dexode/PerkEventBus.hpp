...
public:
    ...
    public:
        template <typename Perk_t> RegisterHelper& registerPrePostpone(perk::Flag (Perk_t::*method)(PostponeHelper&)) {
            _bus->_onPrePostpone.push_back(std::bind(method, static_cast<Perk_t*>(_perk), std::placeholders::_1));
            return *this;
        }

        template <typename Perk_t> RegisterHelper& registerPostPostpone(perk::Flag (Perk_t::*method)(PostponeHelper&)) {
