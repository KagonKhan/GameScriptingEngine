...
protected:
    eventbus::stream::EventStream* streamForEvent(eventbus::internal::event_id_t eventID) const override;

    eventbus::stream::EventStream* obtainStream(eventbus::internal::event_id_t eventID,
    ...
    eventbus::stream::EventStream* listen(std::uint32_t listenerID, eventbus::internal::event_id_t eventID,
